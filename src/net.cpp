...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Rubcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"Rubcointools.com", "dnsseed.Rubcointools.com"},
    {"Rubcoinpool.org", "dnsseed.Rubcoinpool.org"},
    {"xurious.com", "dnsseed.RUB.xurious.com"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"Rubcointools.com", "testnet-seed.Rubcointools.com"},
    {"xurious.com", "testnet-seed.RUB.xurious.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Rubcoin is probably already running."), addrBind.ToString().c_str());
        else
