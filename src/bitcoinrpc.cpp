...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Rubcoin server stopping";
}
...
void StartRPCThreads()
{
        ...
        (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"]))
    {
        ...
        string strWhatAmI = "To use Rubcoind";
    ...
    ip::tcp::endpoint endpoint(bindAddress, GetArg("-rpcport", 12666));
...
Object CallRPC(const string& strMethod, const Array& params)
{
    ...
    if (!d.connect(GetArg("-rpcconnect", "127.0.0.1"), GetArg("-rpcport", 12666))))
